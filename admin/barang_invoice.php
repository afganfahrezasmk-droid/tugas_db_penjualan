...
<body>
    ...
    <div class="col-md-10 cpl-md-offset-1">
        <?php
            $id = $_GET['id'];
        ...
        ?>
            ...
            <a href="barang_invoice_cetak.php?id=<?php echo $id; ?>" target="_blank" class="btn btn-primary pull-right"><i class="glyphicon glyphicon-print"></i>Cetak</a>
            <br><br>
